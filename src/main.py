...
libs_dir = os.path.join(current_dir, "AB3DMOT_libs")
...
def main_per_cat(cfg, cat, log, ID_start):
	...
	for seq_name in seq_eval:
		...
		# initialize tracker
		tracker, frame_list = initialize(cfg, trk_root, save_dir, subfolder, seq_name, cat, ID_start, hw, log) ####this should be on init function !
